...
export default function Placements() {
  return (
    <div className="min-h-screen bg-[#0A0028] text-white px-4 py-12">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold mb-2">Job & Internship Opportunities</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {jobs.map((job, index) => (
            <div
              key={index}
              className="bg-[#1C0F45] border border-[#2D1E60] rounded-xl p-6 flex flex-col justify-between"
            >
              ...
              <a
                ...
                className="mt-auto bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 rounded-lg flex justify-center items-center gap-2 transition"
              >
